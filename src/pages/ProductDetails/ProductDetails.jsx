    ...
    <>
      ...
      <section className="bg-white py-5">
        <div className="container flex gap-5">
          ...
          <div className="productContent w-[60%] items-center pl-10">
            ...
            <div className="shadow-md w-[80%] py-5 px-8 rounded-md">
              <div className="w-full productReviewsContainer">
                ...
                <div className="reviewScroll w-full max-h-[300px] overflow-y-scroll overflow-x-hidden mt-5 pr-5">
                  <div className="review pt-5 mb-5 border-b border-[rgba(0,0,0,0.1)] w-full flex items-center justify-between">
                  ...
                  <div className="review pt-5 mb-5 border-b border-[rgba(0,0,0,0.1)] w-full flex items-center justify-between">
                    <div className="info w-[60%] flex items-center  gap-3">
                      ...
                      <div className="w-[70%]">
                        <h4 className="text-[16px] font-[600]">Azizul haque</h4>
                        <h5 className="text-[13px] font-[600]">2025-11-17</h5>
                        <p className="mt-0 mb-0"> awesome product</p>
                      </div>
                    </div>
                    <Rating name="half-rating-read" defaultValue={4} readOnly />
                  </div>
                  <div className="review pt-5 mb-5 border-b border-[rgba(0,0,0,0.1)] w-full flex items-center justify-between">
                    <div className="info w-[60%] flex items-center  gap-3">
                      ...
                      <div className="w-[70%]">
                        <h4 className="text-[16px] font-[600]">Usama</h4>
                        <h5 className="text-[13px] font-[600]">2025-11-17</h5>
                        <p className="mt-0 mb-0">good product</p>
                      </div>
                    </div>
                    <Rating name="half-rating-read" defaultValue={4} readOnly />
                  </div>
                  <div className="review pt-5 mb-5 border-b border-[rgba(0,0,0,0.1)] w-full flex items-center justify-between">
                    <div className="info w-[60%] flex items-center  gap-3">
                      ...
                      <div className="w-[70%]">
                        <h4 className="text-[16px] font-[600]">Ahommed</h4>
                        <h5 className="text-[13px] font-[600]">2025-11-17</h5>
                        <p className="mt-0 mb-0">i like product</p>
                      </div>
                    </div>
                    <Rating name="half-rating-read" defaultValue={4} readOnly />
                  </div>
        ...
        <div className="container">
          <h2 className="text-[22px] font-[600] px-5 pt-5">Related Products</h2>
